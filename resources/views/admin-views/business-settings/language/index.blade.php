        ...
        <div class="row">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h4>{{translate('Language_Setup')}}</h4>
                    <button type="submit" class="btn btn-primary">{{translate('Add_New')}} <i class="fa fa-plus"></i></button>
                </div>
            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="recipient-name"
                                            class="input-label">{{translate('language:')}} </label>
                                    <input type="text" class="form-control" id="recipient-name" name="name" placeholder="{{translate('Ex: English')}}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="message-text" class="input-label">{{translate('country_code:')}}</label>
                ...
                <div class="card">
                    <div class="card-header d-flex flex-column align-items-baseline">
                        <h4>{{translate('Social_Media_Links')}}</h4>
                            ...
                            <table class="table table-borderless table-hover table-thead-bordered table-nowrap table-align-middle card-table">
                                ...
                                @if(!empty($language) && array_key_exists('code', $language[0]))
                                    @foreach($language as $key =>$data)
                                        <tr>
                                            <td>{{$key+1}}</td>
                                            <td class="text-order_id">{{$data['name']}}
                                            </td>
                                            <td>{{$data['code']}}</td>
                                            <td>
                                            ...
                                            <td class="">
                                                <div class="d-flex flex-row align-items-center gap-2">
                                                    ...
                                                    href=""><i style="color:#A1A5B7;" class="tio-edit"></i></a>
                                                    <button type="button" class="btn btn-secondary btn-sm delete square-btn"
                                                    onclick="'{{translate('Want to delete this item ?')}}')"><i style=" color: #A1A5B7;" class="tio-delete"></i></button>
