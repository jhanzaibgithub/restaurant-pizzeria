...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        Route::get('/fcm/{id}', 'DashboardController@fcm')->name('fcm');     //test route
        Route::get('/', 'DashboardController@create')->name('home');
        Route::post('/send-email-to-developer-by-admin', 'SendEmailController@adminFeedback')->name('feedback');
        Route::get('/dashboard', 'DashboardController@dashboard')->name('dashboard');
        Route::post('branch-order-stats', 'DashboardController@branch_orders')->name('branch-order-stats');
        ...
        Route::get('sale-statistics', 'DashboardController@sale_growth_statistics')->name('sale-statistics');
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.', 'middleware' => ['module:pos_management']], function () {
            ...
            Route::get('/get-products', 'POSController@getProducts')->name('get_ajax_products');
        ...
        Route::group(['prefix' => 'addon', 'as' => 'addon.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::get('status/{id}/{status}', 'AddonController@status')->name('status');
        });
        ...
        Route::group(['prefix' => 'product', 'as' => 'product.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::get('filter/reset', 'ProductController@filter_reset');
            ...
            Route::get('update-priority/{id}', 'ProductController@update_priority')->name('priority');
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.', 'middleware' => ['module:product_management']], function () {
            ...
            Route::get('bulk-export', 'CategoryController@bulk_export_index')->name('bulk-export');
            Route::post('bulk-export', 'CategoryController@bulk_export_data');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:system_management']], function () {
            ...
            Route::group(['prefix' => 'web-app', 'as' => 'web-app.', 'middleware' => ['module:system_management']], function () {
                ...
                Route::get('third-party/delivery-system', 'BusinessSettingsController@delivery_system')->name('delivery-system');
                Route::post('delivery-system-update/{payment_method}', 'BusinessSettingsController@delivery_system_update')->name('delivery-system-update');
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.', 'middleware' => ['module:report_and_analytics_management']], function () {
            ...
            Route::get('branch', 'ReportController@branch_index')->name('branch');
            Route::get('customer', 'ReportController@customer_index')->name('customer');
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['actch', 'module:user_management']], function () {
            ...
            Route::post('/send-emails-to-all', 'SendEmailController@sendBulkEmail')->name('sendBulkEmail');
